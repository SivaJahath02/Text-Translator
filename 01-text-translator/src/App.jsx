...
function App() {
  ...
  headers: {
    'x-rapidapi-key': '65818236f3mshe34d2464ba765bcp14db31jsnec6f5928fcc9',
...
return (
    <div className="h-screen w-screen bg-slate-300 flex intems-center justify-center ">
      <div className="flex items-center justify-center flex-col gap-y-10">
        ...
        <div>
          ...
          <select name="value" className="bg-white px-2 py-1 rounded-lg border border-zinc-600 outline-none cursor-pointer" onChange={(e) => setSelectValue(e.target.value)}>
            <option value="">Select</option>
            <option value="hi">Hindi</option>
            <option value="ta">Tamil</option>
          </select>
        </div>
        <button className="bg-slate-700 text-slate-100 mx-auto w-[500px] py-3 rounded-lg cursor-pointer flex item-center justify-center" onClick={handleTextTranslatation}>
          {
